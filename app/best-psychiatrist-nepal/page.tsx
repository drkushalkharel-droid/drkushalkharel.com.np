    ...
    <main className="min-h-screen bg-stone-50 text-stone-900">
      ...
      <article className="mx-auto max-w-5xl space-y-6 px-6 py-14 lg:px-8">
        ...
        <Section title="Patient Experience and Care Approach">
          <p>There is no official "highly recommended" or "top-rated" ranking body for psychiatrists in Nepal, so treat those as search phrases rather than credentials — what can be checked is public, verifiable information such as Nepal Medical Council registration and MD Psychiatry qualification.</p>
          <p>In practice, care here means a few concrete commitments: diagnosis and medication options are explained in plain language, not just prescribed; appointments are structured to cover your full concern rather than being rushed through; the space is confidential and non-judgmental regardless of what you need to discuss; and WhatsApp messages are answered directly for booking and follow-up questions rather than routed through a call center.</p>
          <div className="grid gap-4 sm:grid-cols-2">
