    ...
    <main className="min-h-screen bg-stone-50 text-stone-900">
      ...
      <section className="bg-white">
        <div className="mx-auto max-w-5xl px-6 pb-14 pt-28 lg:px-8 lg:pt-32">
          ...
          <div className="mt-10 rounded-lg border border-stone-200 bg-stone-50 p-5">
            ...
            <p className="text-stone-600">Consultant Psychiatrist · Nepal Medical Council registered · Kathmandu, Nepal</p>
            <p className="text-stone-600">In-person consultation in Kalanki and online consultation where appropriate</p>
          </div>
        </div>
      </section>
      ...
      <article className="mx-auto max-w-5xl space-y-6 px-6 py-14 lg:px-8">
        ...
        <Section title="When Should You See a Psychiatrist?">
          ...
          <h3 className="text-xl font-bold text-sage-950">Symptoms that deserve prompt attention</h3>
        ...
        <Section title="Anxiety Disorder Treatment in Nepal">
          ...
          <p>When I see someone with anxiety, I spend the first session mapping their specific pattern — constant worry, panic attacks, or fear tied to particular situations — because the plan genuinely differs. Most people start with CBT; I only bring medication into the conversation if it's more severe or CBT isn't enough on its own.</p>
          <p><Link href="/anxiety" className="font-semibold text-sage-700 underline">Read the detailed anxiety treatment guide</Link> for symptoms, causes, therapy and online-care information.</p>
        </Section>
        ...
        <Section title="Depression Treatment in Nepal">
          ...
          <p>My first priority with depression is always a safety check, done gently and without alarm. After that, I look at what's realistic for that person — sometimes therapy alone is enough, sometimes medication helps someone get to a place where therapy can actually work, and I review that at every follow-up rather than deciding it once and leaving it.</p>
          <p><Link href="/conditions/major-depressive-disorder" className="font-semibold text-sage-700 underline">Explore the depression information page</Link> for a fuller patient guide.</p>
        </Section>
        ...
        <Section title="OCD Treatment and Intrusive Thoughts">
          ...
          <p>OCD is one of the conditions where I lean on ERP specifically, not just general talk therapy — I walk patients through it step by step, starting with triggers that feel manageable, because jumping in too fast just makes people avoid the process altogether. Medication comes in alongside it when the compulsions are strong enough to make that gradual work too hard on its own.</p>
          <p><Link href="/conditions/ocd" className="font-semibold text-sage-700 underline">Learn more about OCD assessment and treatment</Link>.</p>
        </Section>
        ...
        <Section title="Schizophrenia and Psychosis Treatment">
          ...
          <p>With psychosis and schizophrenia, I try to bring the family into the picture early where the patient welcomes it, because recognising an early warning sign at home matters as much as anything I do in the consultation room. I explain what the medication is doing and why stopping it suddenly is risky, rather than just handing over a prescription.</p>
          <p><Link href="/conditions/schizophrenia" className="font-semibold text-sage-700 underline">Read the schizophrenia patient guide</Link> and use emergency services if behaviour is unsafe or severely disturbed.</p>
        </Section>
        ...
        <Section title="Bipolar Disorder, Panic Attacks and PTSD">
          ...
          <p>These three get mistaken for each other and for plain anxiety more often than people expect, so I spend real time on the distinction before treatment starts — a bipolar depression treated like ordinary depression, for instance, can make things worse rather than better.</p>
        ...
        <Section title="ADHD, Autism, Sleep, Addiction and Dementia">
          ...
          <p>This is a wide list on purpose — general psychiatric practice covers all of it, and I'd rather tell you honestly when something needs a different specialist than stretch to cover ground outside what I can do well.</p>
        </Section>
        ...
        <Section title="How I Actually Practice">
          <p>There is no official "highly recommended" or "top-rated" ranking body for psychiatrists in Nepal, so treat those as search phrases rather than credentials — what you can actually check is public, verifiable information such as Nepal Medical Council registration and MD Psychiatry qualification. Beyond that, the fairest thing I can do is tell you plainly how I work, so you can judge the fit yourself rather than take a search-ranking word for it.</p>
          <p>I don't reach for a prescription pad before I understand your situation. A first visit is a real conversation — your history, what's changed, what's already been tried — and I explain what a diagnosis actually means and why I'm suggesting a particular medication or therapy, in plain language, before you leave the room. Treatment is rarely one-size-fits-all: depending on what's going on, that might mean CBT, ERP for OCD specifically, medication, or a combination, and I say clearly why. I see patients at the Kalanki clinic and by Google Meet for people elsewhere in Nepal or abroad, and WhatsApp messages come to me directly, not a call centre.</p>
          <div className="grid gap-4 sm:grid-cols-2">
...
function Section({ title, children }: { title: string; children: React.ReactNode }) {
  return <section className="rounded-lg border border-stone-200 bg-white p-6 shadow-sm md:p-8"><h2 className="text-3xl font-bold text-sage-950">{title}</h2><div className="mt-5 space-y-4 text-lg leading-9 text-stone-700">{children}</div></section>;
}

function Fact({ title, text }: { title: string; text: string }) {
  return <div className="rounded-lg border border-stone-200 bg-stone-50 p-5"><h3 className="font-bold text-sage-950">{title}</h3><p className="mt-2 leading-7 text-stone-600">{text}</p></div>;
}

function InlineLink({ href, children }: { href: string; children: React.ReactNode }) {
  return <Link href={href} className="rounded-lg border border-stone-200 bg-white p-4 font-semibold text-sage-800 transition hover:border-sage-300 hover:bg-sage-50">{children}</Link>;
}
