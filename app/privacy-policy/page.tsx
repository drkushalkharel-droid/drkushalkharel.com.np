  ...
  return (
    <main className="min-h-screen bg-stone-50 text-stone-900">
      ...
      <article className="mx-auto max-w-3xl space-y-8 px-6 py-14 lg:px-8">
        <section>
          <h2 className="text-2xl font-bold text-sage-950">Overview</h2>
        ...
        <section>
          <h2 className="text-2xl font-bold text-sage-950">
        ...
        <section>
          <h2 className="text-2xl font-bold text-sage-950">Cookies</h2>
          <p className="mt-3 leading-8 text-stone-600">
