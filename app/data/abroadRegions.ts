...
export const regions: Region[] = [
  {
    ...
    quickAnswer:
      "Yes, Nepalis working or living in the Gulf can see a Nepali psychiatrist online. Dr. Kushal Kharel, a Nepal Medical Council-registered Consultant Psychiatrist in Kathmandu, offers online therapy and video consultation for Nepalis abroad in the UAE, Qatar, Saudi Arabia, Kuwait, Oman and Bahrain through Google Meet, in Nepali or English, at a time that suits your time zone. He treats constant worry, anxiety, intrusive thoughts, sleep problems and depression, and every session is confidential, including from employers.",
    intro: [
  ...
  },
  {
    ...
    quickAnswer:
      "Yes, Nepalis in Japan and South Korea can see a Nepali psychiatrist online. Dr. Kushal Kharel, a Nepal Medical Council-registered Consultant Psychiatrist in Kathmandu, offers online therapy and video consultation for Nepalis abroad through Google Meet, in Nepali or English, at a time that suits your time zone. He treats constant worry, anxiety, intrusive thoughts, sleep problems and depression, and every session is confidential.",
    intro: [
  ...
  },
  {
    ...
    quickAnswer:
      "Yes, Nepalis in Malaysia and Singapore can see a Nepali psychiatrist online. Dr. Kushal Kharel, a Nepal Medical Council-registered Consultant Psychiatrist in Kathmandu, offers online therapy and video consultation for Nepalis abroad through Google Meet, in Nepali or English, at a time that suits your time zone. He treats constant worry, anxiety, intrusive thoughts, sleep problems and depression, and every session is confidential, including from employers.",
    intro: [
