      ...
      <div className="mx-auto grid max-w-7xl gap-10 px-6 lg:grid-cols-[0.95fr_1.05fr] lg:px-8">
        <div>
          ...
          <div className="mt-8 flex flex-wrap gap-4">
            <Link
              href="/screening"
              className="rounded-lg bg-sage-700 px-6 py-3 font-bold text-white transition hover:bg-sage-800"
            >
              Start Screening
            </Link>
            <a
        ...
        <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {featured.map((tool) => (
            ...
            >
              <h3 className="text-xl font-bold text-sage-950">{tool.shortTitle}</h3>
