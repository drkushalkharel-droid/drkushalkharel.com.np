...
export default function CitySeoSection() {
  return (
    <section id="cities" className="bg-stone-50 py-24">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mt-12 rounded-lg bg-sage-950 p-8 text-white">
          ...
          <a
            ...
            className="mt-6 inline-flex items-center gap-3 rounded-lg bg-white px-6 py-3 font-bold text-sage-950 transition hover:bg-sage-50"
          >
