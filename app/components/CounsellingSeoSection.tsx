...
export default function CounsellingSeoSection() {
  return (
    <section id="counselling" className="bg-stone-50 py-20">
      <div className="mx-auto max-w-5xl px-6 lg:px-8">
        <div className="flex flex-col items-start gap-6 rounded-lg border border-stone-200 bg-white p-8 shadow-sm md:flex-row md:items-center md:justify-between">
