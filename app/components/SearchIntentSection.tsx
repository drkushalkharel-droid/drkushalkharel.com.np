    ...
    <section className="bg-white py-20">
      <div className="mx-auto grid max-w-7xl gap-12 px-6 lg:grid-cols-[0.9fr_1.1fr] lg:px-8">
        ...
        <div className="grid gap-5">
          <div className="rounded-lg border border-sage-100 bg-sage-50 p-6">
            ...
            <div className="mt-5 flex flex-wrap gap-3">
              {searchTerms.map((term) => (
                <span
                  key={term}
                  className="rounded-full border border-sage-200 bg-white px-4 py-2 text-sm font-semibold text-sage-900"
                >
                  {term}
                </span>
              ))}
